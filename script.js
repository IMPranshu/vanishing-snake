...
Follow me on twitter for more: https://twitter.com/pkknowsnothing
  ...
  function main(timestamp) {
    try {
      ...
      if (lastTimestamp) {
        ...
        if (contrast == 0) {
          throw Error("You ran out of time & luck!!!");
        }
      ...
      const changeMode = hardMode
        ...
        : "Want higher Difficulty? Press the letter H.";
      const followMe =
        'Follow me <a href="https://twitter.com/pkknowsnothing" , target="_blank">@IMPranshu</a>';
